              ...
              <AnimatedCard className="p-8 rounded-2xl">
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-3xl font-bold mb-4">
                    {category?.title} Quiz ({difficulty === 'easy' ? 'Easy' : difficulty === 'hard' ? 'Hard' : 'Normal'})
                  </h1>
                  <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
                    An AI-generated quiz on {category?.title} focusing on {industry === 'any' ? 'General' : industry.charAt(0).toUpperCase() + industry.slice(1)} context at {difficulty === 'easy' ? 'Easy' : difficulty === 'hard' ? 'Hard' : 'Normal'} difficulty.
                  </p>
                  ...
                  <div className="flex flex-wrap justify-center gap-6 mb-8">
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      {difficulty === 'easy' ? '~5' : difficulty === 'hard' ? '~15' : '~10'} Questions (Approx.)
                    </div>
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      {difficulty === 'easy' ? '~5 min' : difficulty === 'hard' ? '~15 min' : '~10 min'}
                    </div>
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      {difficulty === 'easy' ? 'Easy' : difficulty === 'hard' ? 'Hard' : 'Normal'} Difficulty
                    </div>
                    {industry !== 'any' && (
                      <div className="flex items-center text-sm text-gray-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2 text-gray-400">
                        ...
                        {industry === 'any' ? 'General' : industry.charAt(0).toUpperCase() + industry.slice(1)} Focus
                      </div>
                    )}
                  </div>
                </div>
